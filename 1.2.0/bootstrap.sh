...
echo ""
echo "###############################################################################################"
echo "# Welcome to your Apache Drill v1.2.0 (Embedded mode) Docker image                            #"
echo "#                                                                                             #"
...
echo ""
echo ""
echo "Starting Apache Drill v1.2.0 in embeded mode..."
echo ""
echo ""
...
#
/opt/drill/apache-drill-1.2.0/bin/drill-embedded