...
echo ""
echo "###############################################################################################"
echo "# Welcome to your Apache Drill v1.13.0 (Embedded mode) Docker image                            #"
echo "#                                                                                             #"
...
echo ""
echo ""
echo "Starting Apache Drill v1.13.0 in embeded mode..."
echo ""
echo ""
...
#
/opt/drill/apache-drill-1.13.0/bin/drill-embedded
